...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Verify rental belongs to this user and derive payable amounts from the DB.
    ...
    const amount = dollarsToCents(rental.total_price);
    const deposit = dollarsToCents(rental.deposit_amount ?? 0);
