...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const amount = toCents(rental.total_price, "total_price");
    const deposit = toCents(rental.deposit_amount ?? 0, "deposit_amount");
...
function toCents(value: number | string | null, field: string) {
